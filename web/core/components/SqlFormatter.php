...
class SqlFormatter {
  ...
  public static $quote_attributes = 'style="color: lightblue;"';
  ...
  public static $word_attributes = 'style="color: #c3c3c3;"';
  ...
  public static $pre_attributes = 'style="color: white; background-color: #333; padding: 3px;"';
